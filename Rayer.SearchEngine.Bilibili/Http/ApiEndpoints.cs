...
internal static class ApiEndpoints
{
    ...
    {
        internal const string SearchBvId = "https://api.bilibili.com/x/web-interface/search/type?__refresh__=true&_extra=&context=&page=1&page_size=30&platform=pc&highlight=1&single_column=0&keyword={0}&category_id=&search_type=video&dynamic_offset=0&preload=true&com2co=true";
