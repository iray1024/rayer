...
internal class ParamBuilder(string httpEndpoint, string apiEndpoint)
{
    private Dictionary<string, string> _params = [];

    public ParamBuilder WithParam(string name, string value)
    {
    ...
    public ParamBuilder WithParams(Dictionary<string, string> @params)
    {
        _params = @params;
