...
internal partial class Api(IHttpClientProvider httpClientProvider) : RequestBase(httpClientProvider)
{
    ...
    public async Task<MusicFcgApiResult?> Search(string keyword, SearchTypeEnum searchType)
    {
        ...
        var resp = await PostAsJsonAsync("https://u.y.qq.com/cgi-bin/musicu.fcg", data);
    ...
    {
        var data = "{\"music.search.SearchCgiService\": {\"method\": \"DoSearchForQQMusicDesktop\",\"module\": \"music.search.SearchCgiService\",\"param\": {\"num_per_page\": 10,\"page_num\": 1,\"query\": \"" + keyword + "\",\"search_type\": 0}}}";
    ...
    public async Task<AlbumResult?> GetAlbum(string albumMid)
    {
        ...
        var resp = await PostAsJsonAsync("https://c.y.qq.com/v8/fcg-bin/fcg_v8_album_info_cp.fcg", data);
    ...
    public async Task<AlbumSongListResult?> GetAlbumSongList(string mid, int page = 1, int pageSize = 1000)
    {
        ...
        var resp = await PostAsJsonAsync("https://u.y.qq.com/cgi-bin/musicu.fcg?g_tk=5381&format=json&inCharset=utf8&outCharset=utf-8", data);
    ...
    public async Task<SingerSongResult?> GetSingerSongs(string singerMid, int page = 1, int pageSize = 20)
    {
        ...
        var resp = await PostAsJsonAsync("http://u.y.qq.com/cgi-bin/musicu.fcg", data);
    ...
    {
        var timeType = id switch
        {
            4 or 27 or 62 => "yyyy-MM-dd",
            _ => "yyyy-W",
        };
        var postPeriod = period ?? DateTime.Now.ToString(timeType);
    ...
    public async Task<PlaylistResult?> GetPlaylist(string playlistId)
    {
        ...
        var resp = await PostAsJsonAsync("https://c.y.qq.com/qzone/fcg-bin/fcg_ucc_getcdinfo_byids_cp.fcg", data);
    ...
    public async Task<SongResult?> GetSong(string id)
    {
        ...
        var resp = await PostAsJsonAsync("https://c.y.qq.com/v8/fcg-bin/fcg_play_single_song.fcg", data);
    ...
    public async Task<LyricResult?> GetLyric(string songMid)
    {
        ...
        var resp = await PostAsFormAsync("https://c.y.qq.com/lyric/fcgi-bin/fcg_query_lyric_new.fcg", data);
    ...
    {
        return NumberMatcher().IsMatch(str);
    }
