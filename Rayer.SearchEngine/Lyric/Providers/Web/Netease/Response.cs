...
public class LyricResult : ILyricResult
{
    ...
    public LyricWrapper GetLyric()
    {
        ...
        {
            Lyric = Lrc is not null && !string.IsNullOrEmpty(Lrc.Lyric) ? Lrc.Lyric : null,
            Translationrc = Tlyric is not null && !string.IsNullOrEmpty(Tlyric.Lyric) ? Tlyric.Lyric : null,
            Romalrc = Romalrc is not null && !string.IsNullOrEmpty(Romalrc.Lyric) ? Romalrc.Lyric : null,
            Yrc = Yrc is not null && !string.IsNullOrEmpty(Yrc.Lyric) ? Yrc.Lyric : null,
